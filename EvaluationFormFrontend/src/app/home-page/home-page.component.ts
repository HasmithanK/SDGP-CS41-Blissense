    ...
    <!-- <div class="footer">
      ...
      <div id="introContainer">
        <div id="introContentContainer">
          <div id="introContent">
            <div id="introBody">
              <div id="introHeading">Blissense</div> <br>
          ...
          <img src="./assets/HappyPeople.jpg" alt="Image of Happy People" id="introContentImg">
        </div>
      </div>
      ...
      <div id="videoChatContainer">
        <div id="videoChatContent">
          ...
          <div id="videoChatBody">
            Looking for a space to unwind, share thoughts, 
            and connect with others? Look no further! Our 
            platform pairs you with random users for genuine 
            conversations. Whether you want to vent, discuss hobbies,
            or simply open up, our platform provides a safe and welcoming environment.
          </div>
        </div>
